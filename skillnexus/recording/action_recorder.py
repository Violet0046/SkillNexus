...
Ported from OpenSpace with import path adaptations.
"""
...
def analyze_agent_actions(actions: list) -> Dict[str, Any]:
    if not actions:
        return {"total_actions": 0, "by_agent": {}, "by_type": {}}
    ...
    return {"total_actions": len(actions), "by_agent": by_agent, "by_type": by_type}
