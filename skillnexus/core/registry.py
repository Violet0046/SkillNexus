...
class SkillRegistry:
    ...
    def discover_from_dirs(self, extra_dirs: List[Path]) -> List[SkillMeta]:
        ...
        external skills (e.g. newly downloaded cloud skills).
    ...
    def build_context_injection(
        ...
        Args:
            ...
            backends: Active backend names (e.g. ``["shell"]``).  Used to
        ...
        scope = set(backends) if backends else {"shell"}
        ...
        resource_tip = (
            ...
            + (" and `shell_agent` for running scripts" if "shell" in scope else "")
